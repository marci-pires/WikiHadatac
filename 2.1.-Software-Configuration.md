...
In development mode, you may just need to update a few files including __hadatac.conf__, and that that change can be done directly in the local copy of what is in the master branch. In case code is contributed back to the master branch, __please do not add and commit changes to [HADatAc]/conf__.  
