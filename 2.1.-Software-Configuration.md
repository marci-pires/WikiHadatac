...
Each HADatAc installation has one Master user. This user can only be created once, and the password used to create this user needs to be carefully noted.
