...
* __ontology priority (optional for loaded ontologies)__: this is an integer greater than 0, which indicates the priority of an ontology for sdd-editor suggestions. The lower the number the higher the priority and the more likely the sdd-editor will suggest terms from that ontology.
