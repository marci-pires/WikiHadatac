...
This configuration file specifies the folders where uploaded files are stored when they are initially uploaded into HADatAc, and where they are stored after HADatAc has processed them (i.e., when their data has been ingested). Data Files and metadata files that are uploaded into HADatAc are managed as part of the overall content of the app. 
