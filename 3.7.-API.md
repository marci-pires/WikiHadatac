...
studies/objectcollections/:studyuri
studies/units/:studyuri
variables/all
variables/:variableuri
units/all
deployments/all
objectcollections/size/:ocuri
objectcollections/:ocuri/all
objectcollections/:ocuri/:offset
indicators/all
measurements/:studyuri/:variableuri/:objuri
measurements/:studyuri/:variableuri/:objuri/timerange                      measurements/:studyuri/:variableuri/:objuri/:fromdatetime/:todatetime
