...
* by writing an STD file as described in [Section 5.3](https://github.com/paulopinheiro1234/hadatac/wiki/5.3.-Stream-Specification-(STR)) and manually submitting the STD file for ingestion as described in [Section 3.2.1]( https://github.com/paulopinheiro1234/hadatac/wiki/3.2.-Manage-Data-File-Ingestion#321-manual-data-file-ingest). 
