This option is used to manage the collection of data streams use in the infrastructure. Initial specification of streams are done withe use of STR metadata files as described in Section . 
