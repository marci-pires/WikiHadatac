HADatAc calls _data uploading_ the process of adding data files into the data repository, and _data ingestion_ the process of moving data file contents into databases. 
