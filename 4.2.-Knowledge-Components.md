...
Ontologies are used to build the Knowledge graph and also to specify metadata specifications described in [Section 4.3](https://github.com/paulopinheiro1234/hadatac/wiki/4.3.-Metadata-Specification-(SSD,-OAS,-SDD)). This is the ontology that is loaded during knowledge bootstrap discussed on [Step 4 Section 2.2](https://github.com/paulopinheiro1234/hadatac/wiki/2.2.-Knowledge-Graph-Bootstrap#step-4-upload-domain-ontology)
