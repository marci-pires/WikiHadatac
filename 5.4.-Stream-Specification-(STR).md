...
Stream specifications identify resources necessary for ingesting the content of CSV files and messaging systems' messages into HADatAc's Knowledge Graph. An STR is a CSV file itself composed of one row of data (i.e., a record) composed of the following eight fields (columns):
