...
Stream specifications identify resources necessary for processing content of CSV files and messaging systems' messages. An STR is a CSV file itself composed of one row of data (i.e., a record) composed of the following eight fields (columns):
