...
#### SDD-Level Rule 2 
If SDD contain the following sheets: dictionaryFile, codeBookFile, timelineFile, and codeMappingFile  
__Consequence of breaking the rule__:  HADatAc will skip reading the File and generate an error message but will not stop processing the SDD 
...
__Correction__: The user should check if the missing sheet(s) is(are) needed.  
