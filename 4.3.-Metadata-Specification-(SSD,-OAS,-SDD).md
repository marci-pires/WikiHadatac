...
deployment    | deployment URI originating data file's content 
...
study | data-file-name | data-dictionary | deployment | row-scope | cell-scope | owner-scope | permission-url
----- | -------------- | --------------- | ---------- | --------- | ---------- | ----------- | --------------
