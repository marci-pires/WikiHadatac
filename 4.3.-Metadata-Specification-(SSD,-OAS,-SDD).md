...
--------- | ----- | -----------
data-file-name | demographics2* | a mask name for data files 
data-dictionary | SDD-demographics | SDD for data interpretation
row-scope |   |  row level scope
cell-scope |    |  cell level scope
owner-email | joe@example.org | data owner 
permission-url | http://example\#team | data access policy
