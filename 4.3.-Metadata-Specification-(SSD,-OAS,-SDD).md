...
### SDD-Level Rule 1 
Semantic Data Dictionary (SDD) must contain an nfo sheet
Consequence of brexdaking the rule:  HADatAc will stop processing the SDD
Error message: “readCatalog exception”
Correction: Include an infosheet that contains content

### SDD-Level Rule 2 
SDD must contain the following sheets: dictionaryFile, codeBookFile, timelineFile, and codeMappingFile.
Consequence of breaking the rule:  HADatAc will skip the File and generate an error message but will not stop processing the SDD
...
Correction: Add the missing sheet(s)
...
Consequence of breaking the rule:  HADatAc will generate an error message but will not stop processing the SDD
Error message: “The following URIs in the Dictionary Mapping are unresolvable: <list of cell content, which are URIss>
Correction: Correct the content in the indicated cells
...
Consequence of breaking the rule: HADatAc will generate an error message but will not stop processing the SDD
Error message: “"The Attributes: xxx  NOT hasco:StudyIndicator .”
Correction: complete the ontology or check if the ontology loaded is complete
