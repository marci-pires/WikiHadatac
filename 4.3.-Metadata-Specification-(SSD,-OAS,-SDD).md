...
__Correction__: Include an infosheet that contains content  
...
__Consequence of breaking the rule__:  HADatAc will generate an error message but will not stop processing the SDD  
__Error message__: “The following URIs in the Dictionary Mapping are unresolvable: <list of cell content, which are URIss>  
__Correction__: Correct the content in the indicated cells  
...
__Error message__: “"The Attributes: xxx  NOT hasco:StudyIndicator .”  
__Correction__: complete the ontology or check if the ontology loaded is complete  
