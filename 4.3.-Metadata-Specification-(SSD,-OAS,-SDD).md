...
sheet |	hasURI	| type	| isMemberOf | hasScope | hasTimeScope | hasSpaceScope | cardinality	| role | Grounding Label
----- | ------- | ----- | ---------- | -------- | ------------ | ------------- | -----------	| ---- | ---------------  
| | kb:STD-A | hasco:Study | | | | | | |   
#SOC-SUBJECTS | kb:SOC-SUBJECTS	| hasco:SubjectGroup | kb:STD-A | | | | 6 | ont:isSubjectOf  | Child  
