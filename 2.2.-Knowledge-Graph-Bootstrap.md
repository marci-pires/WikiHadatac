...
**IMPORTANT NOTE ABOUT UPLOAD ONTOLOGIES: This step should only be performed as described here as part of the knowledge graph bootstrap process. Any attempt to upload ontologies as described here after a knowledge graph has been bootstrapped will corrupt the existing knowledge graph and invalidate any study data that has already been ingested.** 
