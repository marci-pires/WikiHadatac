...
* files that start with "DPL-" and conform with the DPL structure described in Section , or 
* files that start with "STD-" and conform with the STD structure described in Section , or 
* files that start with "SSD-" and conform with the SSD structure described in Section , or 
