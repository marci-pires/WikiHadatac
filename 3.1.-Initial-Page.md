...
The 
One HADatAc installation has two distinct environments, each one with its own knowledge graph:

* __main environment__ (a.k.a. out of sandbox)
* __sandbox environment__ (a.k.a. in sandbox)
